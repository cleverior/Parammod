...
package ela.riskey.parammod.filechooser;
...
public class FileChooserActivity extends SherlockFragmentActivity implements
	...
	public static final String EXTERNAL_BASE_PATH = Environment
			.getExternalStorageDirectory().getAbsolutePath() + "/riskey/param/";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getSupportActionBar().setHomeButtonEnabled(hasBackStack);
		return true;
	}
